...
self.addEventListener('fetch', e => {
  ...
  // API: network first
  if (url.hostname.includes('generativelanguage.googleapis.com') || url.hostname.includes('api.groq.com') || url.hostname.includes('api.elevenlabs.io')) {
